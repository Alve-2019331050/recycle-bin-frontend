...
const ProductCard = ({ product }) => {
  return (
    <div className="shadow-2xl border-gray-600 card mt-4 hover:scale-105 transition-all ease-in-out duration-500 cursor-pointer" style={{ width: '300px', height: '450px' }}>
