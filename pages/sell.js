                ...
                <div className="grid grid-cols-3 mb-10">
                    ...
                    <div>
                        <form onSubmit={handleSubmit}>
                            ...
                            <button type="submit" className="btn btn-dark mt-4 mx-40 hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">
                                Add
                            </button>
                        </form>
                    </div>
